...
static const char *fonts[]          = {"Iosevka:style=Regular:pixelsize=50"};
static const char dmenufont[]       = "Noto Sans:style=Regular:pixelsize=50";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Up,     spawn,          {.v = brightnessup} },
	{ MODKEY,                       XK_Down,   spawn,          {.v = brightnessdown} },
